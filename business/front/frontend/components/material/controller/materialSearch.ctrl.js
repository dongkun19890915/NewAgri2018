...
define(['../module'], function (moduleApp) {
    'use strict';
    var materialSearchCtrl = function($scope,materialServ,$state) {
        ...
        var initPage = function(){
            ...
            $scope.$watch(
                'paginationConf.currentPage + paginationConf.itemsPerPage',getFileList);
        };
        initPage();
    ...
    moduleApp.controller('materialSearchCtrl',['$scope','materialServ','$state',materialSearchCtrl]);
});