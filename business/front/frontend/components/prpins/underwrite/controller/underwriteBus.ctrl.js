...
define(['../module'], function (moduleApp) {
    'use strict';
    var underwriteBusCtrl = function($scope,$state,underwriteSurServ,$stateParams) {
    ...
    moduleApp.controller('underwriteBusCtrl',['$scope','$state','underwriteSurServ','$stateParams',underwriteBusCtrl]);
});
