...
.provider( '$tooltip', function () {
   ...
   *     // place tooltips left instead of tpl by default
      ...
      return {
        ...
        link: function link ( scope, element, attrs ) {
          ...
          var positionTooltip = function (){
            ...
            // Calculate the tooltip's tpl and left coordinates to center it with
            // this directive.
...
.directive('tab', ['$parse', function($parse) {
  return {
    ...
    scope: {
      heading: '@',
      headingCount: '@',    // 补充参数：显示头部数量
      onSelect: '&select', //This callback is called in contentHeadingTransclude
                          //once it inserts the tab's content into the dom
      onDeselect: '&deselect',
      isActive:'='          // 配置tab激活状态，控制tab的active
    },
    controller: function() {
    ...
    function ($compile, $parse, $q, $timeout, $document, $position, typeaheadParser) {
        ...
        return {
            ...
            link:function (originalScope, element, attrs, modelCtrl) {
                ...
                var popupState = originalScope.$eval(attrs.popupState) !== false;
                ...
                if(popupState){
                    ...
                    popUpEl = angular.element('<div typeahead-popdown></div>');
                }
...
.directive('typeaheadPopdown', function () {
    return {
        restrict:'EA',
        scope:{
            matches:'=',
        ...
        replace:true,
        templateUrl:'template/typeahead/typeahead-popdown.html',
        link:function (scope, element, attrs) {
