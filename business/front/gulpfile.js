...
gulp.task('images', function(){
    ...
    gulp.src(['frontend/images/**/*.{png,jpg,gif,svg,ico}'])
...
gulp.task('css', function() {
    ...
    gulp.src(['frontend/css/**/*.css','!frontend/css/**/*.min.css'])
        .pipe(minifyCss(options))
        .pipe(gulp.dest('dest/css'));
    gulp.src('frontend/css/**/*.min.css')
        .pipe(gulp.dest('dest/css'));
    gulp.src('frontend/css/fonts/*.*')
        .pipe(gulp.dest('dest/css/fonts'));

    gulp.src(['frontend/fonts/css/**/*.css','!frontend/fonts/css/**/*.min.css'])
        .pipe(minifyCss(options))
        .pipe(gulp.dest('dest/fonts/css'));
    gulp.src('frontend/fonts/css/**/*.min.css')
        .pipe(gulp.dest('dest/fonts/css'));
    gulp.src('frontend/fonts/**/*.*')
        .pipe(gulp.dest('dest/fonts'));

    gulp.src('frontend/mock/*.*')
