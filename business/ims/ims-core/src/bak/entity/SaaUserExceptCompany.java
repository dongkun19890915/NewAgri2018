 ...
 * 业务权限除外机构表-Saa_UserExceptCompany   基础数据对象
 */
@Entity
@Table(name = "Saa_UserExceptCompany")
@IdClass(SaaUserExceptCompanyKey.class)
public class SaaUserExceptCompany implements BaseEntity, java.io.Serializable {
