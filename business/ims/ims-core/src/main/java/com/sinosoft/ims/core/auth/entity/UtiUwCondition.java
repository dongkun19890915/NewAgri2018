 ...
 * UtiUwCondition实体操作对象
 */
@Entity
@Table(name = "UtiUwCondition")
@IdClass(UtiUwConditionKey.class)
public class UtiUwCondition extends BaseEntityImpl{
	...
	private String riskCode ;/** 属性classCode/classCode */
	@Id
	@Column(name = "classCode")
	private String classCode ;/** 属性uwType/uwType */
	@Id
	@Column(name = "uwType")
	...
	/**
	 * 属性codeTypeValue/codeTypeValue的getter方法
	 */
	public String getCodeTypeValue() {
		return codeTypeValue;
	}
	/**
	 * 属性codeTypeValue/codeTypeValue的setter方法
	 */
