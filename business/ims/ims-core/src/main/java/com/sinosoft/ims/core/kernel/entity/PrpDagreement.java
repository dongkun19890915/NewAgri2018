 ...
 */
@Entity
@Table(name = "PrpDagreement")
@IdClass(PrpDagreementKey.class)
public class PrpDagreement extends BaseEntityImpl{
	...
	@Column(name = "maxOverDueCountSet")
