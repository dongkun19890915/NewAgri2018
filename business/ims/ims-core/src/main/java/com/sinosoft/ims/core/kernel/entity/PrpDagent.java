...
@IdClass(PrpDagentKey.class)
public class PrpDagent extends BaseEntityImpl{
	...
	@Column(name = "salePersonPermitNo")
	...
	/** 属性减免税起期/减免税起期 */
	@Column(name = "dutyFreeStartTime")
	private String dutyFreeStartTime ;
	/** 属性减免税止期/减免税止期 */
	@Column(name = "dutyFreeEndTime")
