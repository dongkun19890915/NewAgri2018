 ...
 * @description UtiSysParamApi接口
 */
@FeignClient(name = IMSConstant.IMS_SERVICE_NAME, path = UtiSysParamApi.PATH)
public interface UtiSysParamApi {

    public static final String PATH = "utiSysParam";
