 ...
 * @description UtiTaskRuleGroupApi接口
 */
@FeignClient(name = IMSConstant.IMS_SERVICE_NAME, path = UtiTaskRuleGroupApi.PATH)
public interface UtiTaskRuleGroupApi {

    public static final String PATH = "utiTaskRuleGroup";
