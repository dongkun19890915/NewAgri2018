 ...
 * 机构代码表Api操作对象
 */
public class PrpDcompanyDto extends BaseRequest implements Serializable{
	...
	private List<PrpDcompanyDto> prpDcompanyDtoList=new ArrayList<>();


	public PrpDcompanyDto() {
	}

	public PrpDcompanyDto(String comCode,String upperComCode) {
