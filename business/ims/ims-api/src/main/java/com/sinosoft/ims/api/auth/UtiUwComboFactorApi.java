 ...
 * @description UtiUwComboFactorApi接口
 */
@FeignClient(name = IMSConstant.IMS_SERVICE_NAME, path = UtiUwComboFactorApi.PATH)
public interface UtiUwComboFactorApi {

    public static final String PATH = "utiUwComboFactor";
