...
public class CompanyConditionDto extends BasePageableRequest implements java.io.Serializable {
	...
	/** 属性UpperComCodes/上级机构代码列表 */
	private List<String> upperComCodes;
	/** 属性Url/网址 */
	private String url ;
	...
	public List<String> getUpperComCodes()
    {
        return upperComCodes;
    }
    public void setUpperComCodes(List<String> upperComCodes)
    {
        this.upperComCodes = upperComCodes;
    }
