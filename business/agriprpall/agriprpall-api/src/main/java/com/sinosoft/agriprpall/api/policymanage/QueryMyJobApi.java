...
*/
@FeignClient(name = AgriPrpallConstant.AGRI_PRPALL_SERVICE_NAME, path = QueryMyJobApi.PATH)
public interface QueryMyJobApi {
    public static final String PATH = "QueryMyJob";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "queryMyJobByCondition" ,method = {RequestMethod.POST})
    public @ResponseBody
     ...
     * @throws Exception
     */
    @RequestMapping(value = "queryMyJobByCount",method = {RequestMethod.POST})
    public @ResponseBody
    QueryMyJobCountDto queryMyJobByCount(@RequestBody Map<String,String> map)throws Exception;
}
