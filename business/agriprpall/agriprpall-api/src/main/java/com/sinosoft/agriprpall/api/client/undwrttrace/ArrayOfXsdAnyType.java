...
/**
 * <p>ArrayOf_xsd_anyType complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
...
@XmlType(name = "ArrayOf_xsd_anyType", namespace = "http://server.webservice.indiv.sinosoft.com", propOrder = {
    "item"
})
public class ArrayOfXsdAnyType {
