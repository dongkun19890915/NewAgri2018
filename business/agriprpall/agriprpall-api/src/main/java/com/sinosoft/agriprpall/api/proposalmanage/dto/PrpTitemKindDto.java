 ...
 * 标的子险信息Api操作对象
 */
public class PrpTitemKindDto extends BaseRequest implements Serializable{
	...
	private Double agriUnitOutputMain;
	...
	@JsonFormat(pattern = "yyyy-MM-dd",timezone = "GMT+8")
	private Date agriEndDate;
	@JsonFormat(pattern = "yyyy-MM-dd",timezone = "GMT+8")
	private Date agriStartDate;
	...
	public Double getAgriUnitOutputMain() {
		return agriUnitOutputMain;
	}

	public void setAgriUnitOutputMain(Double agriUnitOutputMain) {
	...
	public Date getAgriEndDate() {
		return agriEndDate;
	}

	public void setAgriEndDate(Date agriEndDate) {
		this.agriEndDate = agriEndDate;
	}

	public Date getAgriStartDate() {
		return agriStartDate;
	}

	public void setAgriStartDate(Date agriStartDate) {
