 ...
 * @description 大户田块信息Api接口
 */
@FeignClient(name = AgriPrpallConstant.AGRI_PRPALL_SERVICE_NAME, path = PrpTfeildApi.PATH)
public interface PrpTfeildApi {

    public static final String PATH = "prpTfeild";
