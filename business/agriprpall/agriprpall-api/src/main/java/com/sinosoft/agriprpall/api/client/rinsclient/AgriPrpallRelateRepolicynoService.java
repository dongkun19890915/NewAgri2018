 ...
 * 
 */
@WebService(name = "AgriPrpallRelateRepolicynoService", targetNamespace = "http://server.webservice.indiv.sinosoft.com")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface AgriPrpallRelateRepolicynoService {
