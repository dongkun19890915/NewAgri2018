 ...
 * 批改保单信息表Api操作对象
 */
public class PrpPmainDto extends BaseRequest implements Serializable{
...
//	}
	 ...
	 */
	public java.util.Date getRateEndDate() {
		return rateEndDate;
	}
	/**
	 * 属性费率别终止日期/费率别终止日期的setter方法
	 */
	public void setRateEndDate(java.util.Date rateEndDate) {
	 ...
	 */
	public java.util.Date getRateStartDate() {
		return rateStartDate;
	}
	/**
	 * 属性费率别实施日期/费率别实施日期的setter方法
	 */
	public void setRateStartDate(java.util.Date rateStartDate) {
