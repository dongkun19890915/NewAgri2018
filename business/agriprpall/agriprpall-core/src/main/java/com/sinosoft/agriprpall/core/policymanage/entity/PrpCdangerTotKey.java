 ...
 * PrpCdangerTot主键操作对象
 */
public class PrpCdangerTotKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpCdangerTotKey(){}
	public PrpCdangerTotKey(String proposalNo,java.lang.Integer dangerNo,String sCurrency){
