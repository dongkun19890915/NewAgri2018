 ...
 */
@Entity
@Table(name = "PrpPmainCopy")
@IdClass(PrpPmainCopyKey.class)
public class PrpPmainCopy extends BaseEntityImpl{
...
//	private Date payfefTime ;
	 ...
	 * @param makeCom 出单机构
	 */
	public PrpPmainCopy(String endorseNo, String policyNo, String insuredCode, String insuredName, Double chgPremium, String makeCom) {
