 ...
 */
@Entity
@Table(name = "PrpPplanCoinsCopy")
@IdClass(PrpPplanCoinsCopyKey.class)
public class PrpPplanCoinsCopy extends BaseEntityImpl{
	...
	private Integer serialNo ;/** 属性coinsCode/coinsCode */
	@Id
	@Column(name = "coinsCode")
	private String coinsCode ;/** 属性缴费原因/缴费原因 */
	@Id
