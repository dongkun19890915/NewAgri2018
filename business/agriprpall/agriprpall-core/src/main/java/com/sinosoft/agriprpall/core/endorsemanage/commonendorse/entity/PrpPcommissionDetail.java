...
@IdClass(PrpPcommissionDetailKey.class)
public class PrpPcommissionDetail extends BaseEntityImpl{
	...
	/** 属性chgCodeFee/chgCodeFee */
	@Column(name = "chgCodeFee")
	private String chgCodeFee ;
	/** 属性chgFeeOrg/chgFeeOrg */
	@Column(name = "chgFeeOrg")
	private Double chgFeeOrg ;
	/**
	 * 属性批单号/批单号的getter方法
	 */
	...
	/**
	 * 属性chgCodeFee/chgCodeFee的getter方法
	 */
	public String getChgCodeFee() {
		return chgCodeFee;
	}
	/**
	 * 属性chgCodeFee/chgCodeFee的setter方法
	 */
	public void setChgCodeFee(String chgCodeFee) {
		this.chgCodeFee = chgCodeFee;
	} 	
	/**
	 * 属性chgFeeOrg/chgFeeOrg的getter方法
	 */
	public Double getChgFeeOrg() {
		return chgFeeOrg;
	}
	/**
	 * 属性chgFeeOrg/chgFeeOrg的setter方法
	 */
	public void setChgFeeOrg(Double chgFeeOrg) {
		this.chgFeeOrg = chgFeeOrg;
	} 	
}