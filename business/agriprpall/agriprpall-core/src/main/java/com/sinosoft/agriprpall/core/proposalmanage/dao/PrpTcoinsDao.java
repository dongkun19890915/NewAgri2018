 ...
 */
@Repository
public interface PrpTcoinsDao extends JpaBaseDao<PrpTcoins,PrpTcoinsKey> {

    /**
     * 根据投保单号删除信息
     * @author: 田健
     * @date: 2018/4/12 15:19
     * @param proposalNo 投保单号
     */
    @Modifying
    @Transactional
    @Query(value = "delete from PrpTcoins p where p.proposalNo=:proposalNo")
