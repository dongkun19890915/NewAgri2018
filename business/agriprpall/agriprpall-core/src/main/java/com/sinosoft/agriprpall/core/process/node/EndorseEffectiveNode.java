 ...
 * @author: 何伟东
 */
public class EndorseEffectiveNode extends ProcessNode {

    public EndorseEffectiveNode() {
    }

    public EndorseEffectiveNode(String nodeState) {
        builder(nodeState, NodeType.ENDORSE_EFFECTIVE_NODE, false, false, null);
    }

    public EndorseEffectiveNode(ProcessDto processDto) {
        builder(processDto.getStateCode(), NodeType.ENDORSE_EFFECTIVE_NODE, false, false, processDto);
    }
