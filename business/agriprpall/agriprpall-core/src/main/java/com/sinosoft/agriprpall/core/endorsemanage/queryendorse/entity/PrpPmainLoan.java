 ...
 */
@Entity
@Table(name = "PrpPmainLoan")
@IdClass(PrpPmainLoanKey.class)
public class PrpPmainLoan extends BaseEntityImpl{
	...
	/**
	 * 属性险种类别/险种类别的getter方法
	 */
	public String getRiskKind() {
		return riskKind;
	}
	/**
	 * 属性险种类别/险种类别的setter方法
	 */
	...
	/**
	 * 属性贷款用途	/贷款用途	的getter方法
	 */
	public String getLoanUsage() {
		return loanUsage;
	}
	/**
	 * 属性贷款用途	/贷款用途	的setter方法
	 */
