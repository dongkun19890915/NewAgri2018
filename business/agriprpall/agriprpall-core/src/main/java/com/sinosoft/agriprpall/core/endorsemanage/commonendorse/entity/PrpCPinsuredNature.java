 ...
 */
@Entity
@Table(name = "PrpCPinsuredNature")
@IdClass(PrpCPinsuredNatureKey.class)
public class PrpCPinsuredNature extends BaseEntityImpl{
	...
	/**
	 * 属性单位邮编 /单位邮编 的getter方法
	 */
	public String getUnitPostCode() {
		return unitPostCode;
	}
	/**
	 * 属性单位邮编 /单位邮编 的setter方法
	 */
	...
	/**
	 * 属性房产状况房产状况/房产状况房产状况的getter方法
	 */
	public String getHouseProperty() {
		return houseProperty;
	}
	/**
	 * 属性房产状况房产状况/房产状况房产状况的setter方法
	 */
