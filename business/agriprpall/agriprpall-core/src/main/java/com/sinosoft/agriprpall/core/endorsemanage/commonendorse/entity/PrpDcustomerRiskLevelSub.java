...
public class PrpDcustomerRiskLevelSub extends BaseEntityImpl{
	 ...
	 */
	public Integer getMoneyInvolved() {
		return moneyInvolved;
	}
	/**
	 * 属性涉及金额/涉及金额的setter方法
	 */
	public void setMoneyInvolved(Integer moneyInvolved) {
	...
	/**
	 * 属性changeReason/changeReason的getter方法
	 */
	public String getChangeReason() {
		return changeReason;
	}
	/**
	 * 属性changeReason/changeReason的setter方法
	 */
	public void setChangeReason(String changeReason) {
		this.changeReason = changeReason;
	} 	
	/**
	 * 属性手动修改状态/手动修改状态的getter方法
	 */
	public String getReserved1() {
		return reserved1;
	}
	/**
	 * 属性手动修改状态/手动修改状态的setter方法
	 */
