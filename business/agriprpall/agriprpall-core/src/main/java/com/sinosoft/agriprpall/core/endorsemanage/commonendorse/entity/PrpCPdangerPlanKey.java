 ...
 * PrpCPdangerPlan主键操作对象
 */
public class PrpCPdangerPlanKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpCPdangerPlanKey(){}
	public PrpCPdangerPlanKey(String endorseNo,Integer dangerNo,Integer serialNo){
