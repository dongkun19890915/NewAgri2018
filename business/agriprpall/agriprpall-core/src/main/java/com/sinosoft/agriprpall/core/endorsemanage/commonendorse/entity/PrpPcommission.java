...
@IdClass(PrpPcommissionKey.class)
public class PrpPcommission extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性批单号/批单号 */
	@Id
	@Column(name = "endorseNo")
	private String endorseNo ;/** 属性险种代码/险种代码 */
	@Id
	...
	/** 属性chgCostFee/chgCostFee */
	@Column(name = "chgCostFee")
	private Double chgCostFee ;
	/**
	 * 属性批单号/批单号的getter方法
	 */
	...
	/**
	 * 属性chgCostFee/chgCostFee的getter方法
	 */
	public Double getChgCostFee() {
		return chgCostFee;
	}
	/**
	 * 属性chgCostFee/chgCostFee的setter方法
	 */
	public void setChgCostFee(Double chgCostFee) {
