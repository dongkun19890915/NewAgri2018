 ...
 */
@Entity
@Table(name = "PrpTdangerCoins")
@IdClass(PrpTdangerCoinsKey.class)
public class PrpTdangerCoins extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性投保单号/投保单号 */
	@Id
	@Column(name = "proposalNo")
	private String proposalNo ;/** 属性dangerNo/dangerNo */
	@Id
