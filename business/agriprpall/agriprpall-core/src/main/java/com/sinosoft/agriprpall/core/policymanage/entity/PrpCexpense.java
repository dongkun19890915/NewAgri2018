 ...
 */
@Entity
@Table(name = "PrpCexpense")
@IdClass(PrpCexpenseKey.class)
public class PrpCexpense extends BaseEntityImpl{
	...
	/**
	 * PrpTexpenseToPrpCexpense
	 */
	public void setPrpTexpenseToPrpCexpense(PrpTexpense prpTexpense){
		this.riskCode =prpTexpense.getRiskCode();
		this.manageFeeRate =prpTexpense.getManageFeeRate();
		this.maxManageFeeRate =prpTexpense.getMaxManageFeeRate();
		this.flag =prpTexpense.getFlag();
		this.salvationRate =prpTexpense.getSalvationRate();
		this.salvationFee =prpTexpense.getSalvationFee();
		this.currency =prpTexpense.getCurrency();
		this.basePerformanceRate =prpTexpense.getBasePerformanceRate();
		this.basePerformance =prpTexpense.getBasePerformance();
		this.encouragePerformanceRate =prpTexpense.getEncouragePerformanceRate();
		this.encouragePerformance =prpTexpense.getEncouragePerformance();
		this.noTaxFee =prpTexpense.getNoTaxFee();
		this.taxRate =prpTexpense.getTaxRate();
		this.taxFee =prpTexpense.getTaxFee();
	}
}