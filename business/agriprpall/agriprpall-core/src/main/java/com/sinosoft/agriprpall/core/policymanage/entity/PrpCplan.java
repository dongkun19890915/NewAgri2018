...
@Entity
@Table(name = "PrpCplan")
@IdClass(PrpCplanKey.class)
public class PrpCplan extends BaseEntityImpl {
     ...
     * PrpTplanToPrpCplan
     */
    public void setPrpTplanToPrpCplan(PrpTplan prpTplan){
        this.endorseNo =prpTplan.getEndorseNo();
        this.serialNo =prpTplan.getSerialNo();
        this.payNo =prpTplan.getPayNo();
        this.payReason =prpTplan.getPayReason();
        this.planDate =prpTplan.getPlanDate();
        this.currency =prpTplan.getCurrency();
        this.planFee =prpTplan.getPlanFee();
        this.delinquentFee =prpTplan.getDelinquentFee();
        this.flag =prpTplan.getFlag();
        this.planStartDate =prpTplan.getPlanStartDate();
        this.planRate =prpTplan.getPlanRate();
        this.currency2 =prpTplan.getCurrency2();
        this.planFee2 =prpTplan.getPlanFee2();
        this.exchangeRateCNY =prpTplan.getExchangeRateCNY();
        this.noTaxPremium =prpTplan.getNoTaxPremium();
        this.taxFee =prpTplan.getTaxFee();
    }
}