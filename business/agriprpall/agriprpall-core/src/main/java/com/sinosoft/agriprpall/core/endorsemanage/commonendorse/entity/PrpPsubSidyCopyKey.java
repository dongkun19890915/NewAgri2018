 ...
 * 政府补贴信息表主键操作对象
 */
public class PrpPsubSidyCopyKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpPsubSidyCopyKey(){}
	public PrpPsubSidyCopyKey(String endorseNo,String subsidyCode,String subsidyType){
