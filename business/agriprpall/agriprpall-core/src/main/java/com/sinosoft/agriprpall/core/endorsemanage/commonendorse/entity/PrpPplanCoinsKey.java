 ...
 * 收费计划表主键操作对象
 */
public class PrpPplanCoinsKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpPplanCoinsKey(){}
	public PrpPplanCoinsKey(String endorseNo,Integer serialNo,String coinsCode,String payReason){
