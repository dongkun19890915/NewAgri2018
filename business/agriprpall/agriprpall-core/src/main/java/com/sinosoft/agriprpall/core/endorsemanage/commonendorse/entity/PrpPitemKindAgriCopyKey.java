 ...
 * 农业险附加信息主键操作对象
 */
public class PrpPitemKindAgriCopyKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpPitemKindAgriCopyKey(){}
	public PrpPitemKindAgriCopyKey(String endorseNo, Integer itemKindNo, String kindCode, Integer times){
