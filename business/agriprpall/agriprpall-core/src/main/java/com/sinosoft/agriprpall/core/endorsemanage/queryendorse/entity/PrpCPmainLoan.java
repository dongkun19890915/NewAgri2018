 ...
 */
@Entity
@Table(name = "PrpCPmainLoan")
@IdClass(PrpCPmainLoanKey.class)
public class PrpCPmainLoan extends BaseEntityImpl{
	...
	/** 属性保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它/保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它 */
	@Column(name = "loanWay")
	...
	/**
	 * 属性贷款相关号１：贷款申请表号/贷款相关号１：贷款申请表号的getter方法
	 */
	public String getLoanNo1() {
		return loanNo1;
	}
	/**
	 * 属性贷款相关号１：贷款申请表号/贷款相关号１：贷款申请表号的setter方法
	 */
	public void setLoanNo1(String loanNo1) {
		this.loanNo1 = loanNo1;
	} 	
	/**
	 * 属性贷款相关号2：贷款审批表号/贷款相关号2：贷款审批表号的getter方法
	 */
	public String getLoanNo2() {
		return loanNo2;
	}
	/**
	 * 属性贷款相关号2：贷款审批表号/贷款相关号2：贷款审批表号的setter方法
	 */
	...
	/**
	 * 属性保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它/保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它的getter方法
	 */
	public String getLoanWay() {
		return loanWay;
	}
	/**
	 * 属性保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它/保额确定方式编码   房屋商品价/成本价/市场评估价--** 贷款银行确定/其它的setter方法
	 */
	...
	/**
	 * 属性贷款银行代码/贷款银行代码的getter方法
	 */
	public String getLoanBankCode() {
		return loanBankCode;
	}
	/**
	 * 属性贷款银行代码/贷款银行代码的setter方法
	 */
	...
	/**
	 * 属性首付比例/首付比例的getter方法
	 */
	public Double getFirstRate() {
		return firstRate;
	}
	/**
	 * 属性首付比例/首付比例的setter方法
	 */
	...
	/**
	 * 属性应收账款流转金额/应收账款流转金额的getter方法
	 */
	public String getAccReceiveAmount() {
		return accReceiveAmount;
	}
	/**
	 * 属性应收账款流转金额/应收账款流转金额的setter方法
	 */
