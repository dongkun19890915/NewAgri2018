 ...
 */
@Entity
@Table(name = "PrpCdangerItem")
@IdClass(PrpCdangerItemKey.class)
public class PrpCdangerItem extends BaseEntityImpl{
	...
	private java.lang.Integer dangerNo ;/** 属性序号(自动生成)/序号(自动生成) */
	@Id
