 ...
 * PrpCcommissionOrigin实体操作对象
 */
@Entity
@Table(name = "PrpCcommissionOrigin")
@IdClass(PrpCcommissionOriginKey.class)
public class PrpCcommissionOrigin extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性保单号/保单号 */
	@Id
	@Column(name = "policyNo")
	private String policyNo ;/** 属性险种/险种 */
	@Id
