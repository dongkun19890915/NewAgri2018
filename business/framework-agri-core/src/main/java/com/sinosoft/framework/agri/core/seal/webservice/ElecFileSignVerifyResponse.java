...
@XmlRootElement(name = "elecFileSignVerifyResponse")
public class ElecFileSignVerifyResponse {

    @XmlElementRef(name = "return", namespace = "http://serv", type = JAXBElement.class, required = false)
