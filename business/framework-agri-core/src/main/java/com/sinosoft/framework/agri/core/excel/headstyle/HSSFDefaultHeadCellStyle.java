...
/**
 * 导出 Excel 2007 （普通Excel） 以上版本的表格的默认头样式
 * @Author: 何伟东
 * @Date: 2017/11/24 10:26
 */
public class HSSFDefaultHeadCellStyle implements HSSFExportHandler {
     ...
     */
    public HSSFDefaultHeadCellStyle(){
        this.titleName = "国元保险";
        this.lastRow = 0;
        this.lastCol = 0;
    }
     ...
     */
    public HSSFDefaultHeadCellStyle(String titleName, int lastRow, int lastCol) {
