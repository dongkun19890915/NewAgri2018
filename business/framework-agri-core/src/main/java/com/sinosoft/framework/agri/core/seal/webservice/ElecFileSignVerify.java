...
@XmlRootElement(name = "elecFileSignVerify")
public class ElecFileSignVerify {

    @XmlElementRef(name = "xmlStr", namespace = "http://serv", type = JAXBElement.class, required = false)
