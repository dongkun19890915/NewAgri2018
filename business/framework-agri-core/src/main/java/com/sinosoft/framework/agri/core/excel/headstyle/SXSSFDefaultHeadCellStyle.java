...
/**
 * 导出 Excel 2007 （大数据量） 以上版本的表格的默认头样式
 * @Author: 何伟东
 * @Date: 2017/11/24 10:26
 */
public class SXSSFDefaultHeadCellStyle implements SXSSFExportHandler {
     ...
     */
    public SXSSFDefaultHeadCellStyle(){
        this.titleName ="国元保险";
        this.lastRow=0;
        this.lastCol=0;
    }
     ...
     */
    public SXSSFDefaultHeadCellStyle(String titleName, int lastRow, int lastCol){
