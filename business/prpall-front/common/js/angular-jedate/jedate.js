...
;(function(root, factory) {
    ...
    jedfn.setHtml = function(opts){
        ...
        var dateymList = !isYYMM ? '<div class="jedatetopym" style="display: none;">' + '<ul class="ymdropul"></ul>' +
        '<p>' +
        '<span class="jedateymchle">&lt;&lt;</span>' +
        '<span class="jedateymchok">关闭</span>' +
        '<span class="jedateymchri">&gt;&gt;</span>' +
        '</p>' + "</div>" :(dateFormat == "YYYY" ? '<ul class="jedayy"></ul>' :　'<ul class="jedaym"></ul>');
        var dateriList = '<ol class="jedaol"></ol><ul class="jedaul"></ul>';
        var bothmsStr = !isYYMM ? '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><input type="text" /></li><i>:</i><li><input type="text" /></li><i>:</i><li><input type="text" /></li></ul></div>' + '<div class="botflex jedatebtn"><span class="jedateok">确认</span><span class="jedateclear">清空</span></div>' :(dateFormat == "YYYY" ? '<div class="botflex jedatebtn"><span class="jedateok" style="width:47.8%">确认</span><span class="jedateclear" style="width:47.8%">清空</span></div>' : '<div class="botflex jedatebtn"><span class="jedateok">确认</span><span class="jedatetodaymonth">本月</span><span class="jedateclear">清空</span></div>');
    ...
    jedfn.createDaysHtml = function(ys, ms, opts){
        ...
        for(var b = 1; b <= daysNum; b++, count++){
            ...
            if(dateOfLimit(year, month, b, true)){
                bCls = jet.ymdDate == thisDate ? "action" : (currOne != thisOne && thisOne == thisDate ? "" : "");
            }else{
                bCls = "disabled";
            }
    ...
    jedfn.chooseYM = function(opts) {
        ...
        var jetopym = boxCell.find(".jedatetopym"), jedateyy = boxCell.find(".jedateyy"), jedatemm = boxCell.find(".jedatemm"), jedateyear = boxCell.find(".jedateyy .jedateyear"),
            jedatemonth = boxCell.find(".jedatemm .jedatemonth"), mchri = boxCell.find(".jedateymchri"), mchle = boxCell.find(".jedateymchle"),mckok = boxCell.find(".jedateymchok"),
        ...
        !ishhmmss && jedateyy.on("click", function() {
            ...
            mckok.removeClass("jedateymchok-auto");
        });
        //下拉选择月
        !ishhmmss && jedatemm.on("click", function() {
            ...
            mckok.addClass("jedateymchok-auto");
        });
        //关闭下拉选择
