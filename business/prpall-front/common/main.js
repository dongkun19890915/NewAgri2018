...
require.config({
    ...
    paths: {
        'ztree':'common/js/ztree/js/jquery.ztree.all.min',
        'jquery':'common/js/jquery/jquery.min',
        'angular':'common/js/angular/angular1.2.20',
        ...
        'tmPagination':'common/js/angular-tm-pagination/tm.pagination',//分页插件
        //工具模块
...
require([
    ...
    angular.element().ready(function () {
        angular.bootstrap($("#ng-app"), ["mc.cherry"]);
    })
});