 ...
 */
@Entity
@Table(name = "PrpModelCoinsDetail")
@IdClass(PrpModelCoinsDetailKey.class)
public class PrpModelCoinsDetail extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性proposalNo/proposalNo */
	@Id
	@Column(name = "modelCode")
	private String modelCode;/** 属性serialNo/serialNo */
	@Id
