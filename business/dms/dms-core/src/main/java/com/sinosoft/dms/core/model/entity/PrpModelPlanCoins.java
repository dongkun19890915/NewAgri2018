 ...
 */
@Entity
@Table(name = "PrpModelPlanCoins")
@IdClass(PrpModelPlanCoinsKey.class)
public class PrpModelPlanCoins extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性投保单号码/投保单号码 */
	@Id
	@Column(name = "modelCode")
	private String modelCode ;/** 属性共保人代码/共保人代码 */
	@Id
