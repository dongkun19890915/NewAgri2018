 ...
 */
@Entity
@Table(name = "PrpModelItemKindAgri")
@IdClass(PrpModelItemKindAgriKey.class)
public class PrpModelItemKindAgri extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性模板代码/模板代码 */
	@Id
	@Column(name = "modelCode")
	private String modelCode ;/** 属性标的序号/标的序号 */
	@Id
