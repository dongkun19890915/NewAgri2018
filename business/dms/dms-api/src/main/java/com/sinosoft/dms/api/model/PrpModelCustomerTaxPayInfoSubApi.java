 ...
 * @description 模板客户纳税人信息表Api接口
 */
@FeignClient(name = DMSConstant.DMS_SERVICE_NAME, path = PrpModelCustomerTaxPayInfoSubApi.PATH)
public interface PrpModelCustomerTaxPayInfoSubApi {

    public static final String PATH = "prpModelCustomerTaxPayInfoSub";
    ...
    void save(@RequestBody PrpModelCustomerTaxPayInfoSubDto prpModelCustomerTaxPayInfoSubDto);
