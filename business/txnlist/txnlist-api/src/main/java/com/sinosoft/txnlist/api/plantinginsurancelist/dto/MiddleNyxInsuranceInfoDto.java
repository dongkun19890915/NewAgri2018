...
public class MiddleNyxInsuranceInfoDto implements Serializable {

    private static final long serialVersionUID = 1L;
    /*投保数量*/
    private Long insureArea;
    /** 属性农民自缴保费/农民自缴保费 */
    ...
    public MiddleNyxInsuranceInfoDto(Double fPremium, Double centralPremium, Double provincePremium, Double cityPremium, Double townPremium, Double otherPremium, Long insureArea, Long iSumInsured) {
    ...
    public Long getInsureArea() {
        return insureArea;
    }

    public void setInsureArea(Long insureArea) {
        this.insureArea = insureArea;
    }
