...
public class InsuranceInfoDto implements Serializable {
    ...
    public InsuranceInfoDto(Double fPremium, Double centralPremium, Double provincePremium, Double cityPremium, Double townPremium, Double otherPremium, Integer insureArea) {
        ...
        this.insureArea = Double.parseDouble(insureArea.toString());
    }

    public InsuranceInfoDto(Double fPremium, Double centralPremium, Double provincePremium, Double cityPremium, Double townPremium, Double otherPremium, Double insureArea, Long iSumInsured) {
        this.fPremium = fPremium;
        this.centralPremium = centralPremium;
        this.provincePremium = provincePremium;
        this.cityPremium = cityPremium;
