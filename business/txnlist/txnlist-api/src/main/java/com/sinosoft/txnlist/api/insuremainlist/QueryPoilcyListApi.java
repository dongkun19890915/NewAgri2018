...
*/
@FeignClient(name = TxnListConstant.TXN_LIST_SERVICE_NAME, path = QueryPoilcyListApi.PATH)
public interface QueryPoilcyListApi {
    public static final String PATH = "queryPoilcyListApi";
     ...
     * @throws 
     */
    @RequestMapping(value = "queryPoilcyList",method = {RequestMethod.POST})
    @ResponseBody
     ...
     * @throws Exception
     */
    @RequestMapping(value = "queryEndorseHerdpolicylist",method = {RequestMethod.POST})
    public @ResponseBody
     ...
     * @date: 2017/10/18 11:44
     */
    @RequestMapping(value = "queryPoilcyNo", method = {RequestMethod.POST})
    @ResponseBody
