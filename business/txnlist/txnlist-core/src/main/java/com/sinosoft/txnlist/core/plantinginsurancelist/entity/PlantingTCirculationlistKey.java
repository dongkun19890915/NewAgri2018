 ...
 * 投保明细表主键操作对象
 */
public class PlantingTCirculationlistKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public PlantingTCirculationlistKey() {
    }
    ...
    public PlantingTCirculationlistKey(String inusreListCode, String fCode, String kindCode) {
