 ...
 * 草莓组合险连带被保险人表主键操作对象
 */
public class CMTManFieldListKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public CMTManFieldListKey() {
    }

    public CMTManFieldListKey(String insureListCode, String fCode, String itemCode, String idCard, String kindCode) {
