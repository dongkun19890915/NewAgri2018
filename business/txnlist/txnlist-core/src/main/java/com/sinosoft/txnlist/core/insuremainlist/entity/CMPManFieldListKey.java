 ...
 * 草莓组合险连带被保险人表3主键操作对象
 */
public class CMPManFieldListKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public CMPManFieldListKey() {
    }

    public CMPManFieldListKey(String insureListCode, String fCode, String itemCode, String idCard, String kindCode) {
