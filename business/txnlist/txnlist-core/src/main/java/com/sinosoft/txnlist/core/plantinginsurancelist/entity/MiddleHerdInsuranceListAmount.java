 ...
 */
@Entity
@Table(name = "MiddleHerdInsuranceListAmount")
@IdClass(MIddleHerdInsuranceListKey.class)
public class MiddleHerdInsuranceListAmount extends BaseEntityImpl {
    ...
    @Column(name = "effamount")
    private Double effamount;
    ...
    public Double getEffamount() {
        return effamount;
    }

    public void setEffamount(Double effamount) {
