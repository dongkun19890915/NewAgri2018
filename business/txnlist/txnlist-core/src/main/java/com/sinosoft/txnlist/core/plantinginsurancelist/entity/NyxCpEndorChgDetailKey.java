 ...
 * nyxcpendorchgdetail主键操作对象
 */
public class NyxCpEndorChgDetailKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public NyxCpEndorChgDetailKey(){}
	public NyxCpEndorChgDetailKey(String inusreListCode,String businessNo,String kindCode,String itemCode){
