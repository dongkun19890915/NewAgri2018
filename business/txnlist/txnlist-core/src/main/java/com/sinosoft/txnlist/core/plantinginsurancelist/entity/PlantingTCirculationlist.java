 ...
 */
@Entity
@Table(name = "PlantingTCirculationlist")
@IdClass(PlantingTCirculationlistKey.class)
public class PlantingTCirculationlist extends BaseEntityImpl {
     ...
     */
    public Date PlantingTCirculationList() {
        return opTime;
    }
