 ...
 * 种植业投保明细主键操作对象
 */
public class NyxInsuranceListKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public NyxInsuranceListKey() {
    }

    public NyxInsuranceListKey(String inusreListCode, String businessNo, String kindCode, String itemCode) {
