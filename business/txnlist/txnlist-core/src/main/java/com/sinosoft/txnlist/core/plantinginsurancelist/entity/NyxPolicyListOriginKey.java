 ...
 * 种植险保单清单最新数据2主键操作对象
 */
public class NyxPolicyListOriginKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public NyxPolicyListOriginKey() {
    }

    public NyxPolicyListOriginKey(String inusreListCode, String businessNo, String kindCode, String itemCode) {
