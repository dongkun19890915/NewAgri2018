 ...
 * 养殖险保单清单最新数据表1主键操作对象
 */
public class HerdPolicyListKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public HerdPolicyListKey() {
    }

    public HerdPolicyListKey(String inusreListCode, String earlAbel, String kindCode, String fCode) {
