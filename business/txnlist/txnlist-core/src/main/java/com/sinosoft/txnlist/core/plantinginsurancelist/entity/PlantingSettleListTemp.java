 ...
 * plantingsettlelisttemp实体操作对象
 */
@Entity
@Table(name = "plantingSettleListTemp")
@IdClass(PlantingSettleListTempKey.class)
public class PlantingSettleListTemp extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性报案号（KEY）/报案号（KEY） */
	@Id
	@Column(name = "registCode")
	private String registCode ;/** 属性时间戳（KEY）/时间戳（KEY） */
	@Id
	@Column(name = "stringTimeStamp")
	private String stringTimeStamp ;/** 属性序列号（KEY）/序列号（KEY） */
	@Id
