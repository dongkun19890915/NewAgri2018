 ...
 * 定损清单农户标的清单表主键操作对象
 */
public class LossRateLossListKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public LossRateLossListKey(){}
	public LossRateLossListKey(String lossListCode,java.lang.Integer serialNo,String fCode,String itemCode,java.lang.Integer lossSerialNo){
