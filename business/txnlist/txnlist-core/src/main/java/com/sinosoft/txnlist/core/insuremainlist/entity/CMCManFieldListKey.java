 ...
 * 草莓组合险连带被保险人表1主键操作对象
 */
public class CMCManFieldListKey extends BasePKImpl {
    private static final long serialVersionUID = 1L;

    public CMCManFieldListKey() {
    }

    public CMCManFieldListKey(String insureListCode, String fCode, String itemCode, String idCard, String kindCode) {
