 ...
 * 定损清单农户标的明细表-物主键操作对象
 */
public class LossRateHerdListKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public LossRateHerdListKey(){}
	public LossRateHerdListKey(String lossListCode,java.lang.Integer serialNo,String fCode,String itemCode,java.lang.Integer lossSerialNo,String earLabel){
