 ...
 * 标的分类表-PrpDItemType   基础数据对象
 */
@Entity
@Table(name = "prpditemtype")
@IdClass(PrpDItemTypeKey.class)
public class PrpDItemType implements BaseEntity,Serializable {
