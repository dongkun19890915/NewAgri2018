 ...
 * 条款险别关系表主键操作对象
 */
public class PrpDclauseKindKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpDclauseKindKey(){}
	public PrpDclauseKindKey(String riskCode,String clauseType,String kindCode,String relateKindCode){
