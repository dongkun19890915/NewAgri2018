 ...
 * 产品限额/免赔表主键操作对象
 */
public class PrpDriskLimitKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpDriskLimitKey(){}
	public PrpDriskLimitKey(String riskCode,String clauseCode,java.lang.Integer serialNo,String limitCode){
