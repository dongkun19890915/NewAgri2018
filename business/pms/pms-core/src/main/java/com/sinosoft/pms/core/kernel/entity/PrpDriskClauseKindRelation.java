...
@IdClass(PrpDriskClauseKindRelationKey.class)
public class PrpDriskClauseKindRelation extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性产品代码/产品代码 */
        @Id
        @Column(name = "riskCode")
	private String riskCode ;/** 属性条款代码/条款代码 */
        @Id
        @Column(name = "clauseCode")
	private String clauseCode ;/** 属性关系代码/关系代码 */
        @Id
        @Column(name = "relationCode")
	private String relationCode ;/** 属性序号/序号 */
        @Id
