 ...
 */
@Entity
@Table(name = "PrpDclauseLimit")
@IdClass(PrpDclauseLimitKey.class)
public class PrpDclauseLimit extends BaseEntityImpl{
	...
	private java.lang.Integer serialNo ;/** 属性限额/免陪代码/限额/免陪代码 */
        @Id
