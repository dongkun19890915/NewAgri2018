...
@IdClass(PrpDriskLimitKey.class)
public class PrpDriskLimit extends BaseEntityImpl{
	...
	private String clauseCode ;/** 属性限额/免赔序号/限额/免赔序号 */
        @Id
        @Column(name = "serialNo")
	private java.lang.Integer serialNo ;/** 属性限额\免赔代码/限额\免赔代码 */
        @Id
