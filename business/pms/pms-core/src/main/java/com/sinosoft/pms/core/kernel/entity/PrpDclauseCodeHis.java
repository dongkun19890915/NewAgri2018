 ...
 */
@Entity
@Table(name = " PrpDclauseCodeHis")
@IdClass( PrpDclauseCodeHisKey.class)
public class  PrpDclauseCodeHis extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性条款代码/条款代码 */
	@Id
	@Column(name = "clauseCode")
	private String clauseCode ;/** 属性修改次数/修改次数 */
	@Id
	@Column(name = "indexNo")
