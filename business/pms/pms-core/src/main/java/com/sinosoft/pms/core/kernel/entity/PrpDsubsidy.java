 ...
 */
@Entity
@Table(name = "PrpDsubsidy")
@IdClass(PrpDsubsidyKey.class)
public class PrpDsubsidy extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性riskCode/riskCode */
	@Id
	@Column(name = "riskCode")
	private String riskCode ;/** 属性comCode/comCode */
	@Id
	@Column(name = "comCode")
	private String comCode ;/** 属性subsidyYear/subsidyYear */
	@Id
	@Column(name = "subsidyYear")
	private String subsidyYear ;/** 属性validStatus/validStatus */
	@Id
	@Column(name = "validStatus")
	private String validStatus ;/** 属性subsidyCode/subsidyCode */
	@Id
	...
	private java.lang.Double subsidyRate ;
	 ...
	 */
	public java.lang.Double getSubsidyRate() {
		return subsidyRate;
	}
	/**
	 * 属性subsidyRate/subsidyRate的setter方法
	 */
	public void setSubsidyRate(java.lang.Double subsidyRate) {
