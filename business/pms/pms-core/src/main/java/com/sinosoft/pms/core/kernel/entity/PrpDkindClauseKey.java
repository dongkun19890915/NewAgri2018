 ...
 */
public class PrpDkindClauseKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpDkindClauseKey(){}
	public PrpDkindClauseKey(String riskCode,String clauseFlag,String kindCode,String language,String clauseCode){
