 ...
 */
@Entity
@Table(name = "PrpDclauseShortRate")
@IdClass(PrpDclauseShortRateKey.class)
public class PrpDclauseShortRate extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性条款代码/条款代码 */
        @Id
        @Column(name = "clauseCode")
	private String clauseCode ;/** 属性短期费率代码/短期费率代码 */
        @Id
        @Column(name = "shortRateId")
	private String shortRateId ;/** 属性序号/序号 */
        @Id
