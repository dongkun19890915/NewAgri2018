 ...
 */
@Entity
@Table(name = "PrpDrateUsual")
@IdClass(PrpDrateUsualKey.class)
public class PrpDrateUsual extends BaseEntityImpl{
	...
	private java.lang.Integer ratePeriod ;/** 属性费率代码▲/费率代码▲ */
        @Id
        @Column(name = "rateCode")
	private String rateCode ;/** 属性币别/币别 */
        @Id
