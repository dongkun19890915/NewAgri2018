 ...
 */
@Entity
@Table(name = "PrpDclauseEngage")
@IdClass(PrpDclauseEngageKey.class)
public class PrpDclauseEngage extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性条款代码/条款代码 */
        @Id
        @Column(name = "clauseCode")
	private String clauseCode ;/** 属性特别约定代码/特别约定代码 */
        @Id
