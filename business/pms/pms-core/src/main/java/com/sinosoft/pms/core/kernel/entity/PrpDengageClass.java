 ...
 */
@Entity
@Table(name = "PrpDengageClass")
@IdClass(PrpDengageClassKey.class)
public class PrpDengageClass extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性特别约定代码/特别约定代码 */
        @Id
        @Column(name = "engageCode")
	private String engageCode ;/** 属性险种分类代码/险种分类代码 */
        @Id
