...
define([
    'angular',
    'common/utilities/constant/regexpConstants',
...
], function (angular, regexpConstants, commonApiServ,city,city_func,city_arr,drag) {
    'use strict';
    console.log("load utilities module");
    /*增加模块依赖*/
    return angular.module('utilities', [])
        .constant('regexpConstants', regexpConstants)
        .service('commonApiServ', ['$$finder',commonApiServ])
        .service('city', city)
