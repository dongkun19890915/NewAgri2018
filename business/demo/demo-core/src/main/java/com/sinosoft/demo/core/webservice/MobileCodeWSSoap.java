...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.sinosoft.demo.core.webservice.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.sinosoft.demo.core.webservice.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns com.sinosoft.demo.core.webservice.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.sinosoft.demo.core.webservice.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.sinosoft.demo.core.webservice.GetDatabaseInfoResponse")
