...
public class AgriScheduleDto extends BaseRequest{
    ...
    /**补充说明 */
    private PrpLRegistExtDto registExtDto;
    ...
    public PrpLRegistExtDto getRegistExtDto() {
        return registExtDto;
    }

    public void setRegistExtDto(PrpLRegistExtDto registExtDto) {
