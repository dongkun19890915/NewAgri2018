 ...
 * @description 工作流节点定义表Api接口
 */
@FeignClient(name = AgriClaimConstant.AGRI_CLAIM_SERVICE_NAME, path = SwfNodeApi.PATH)
public interface SwfNodeApi {

    public static final String PATH = "swfNode";
