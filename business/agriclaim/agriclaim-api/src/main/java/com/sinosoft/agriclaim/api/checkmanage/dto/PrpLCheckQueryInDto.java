 ...
 * 查勘查询入参Api操作对象
 */
public class PrpLCheckQueryInDto extends BasePageableRequest implements Serializable{
	...
	/**
	 * 属性保险大类/保险大类的getter方法
	 */
	public String getRiskType() {
		return riskType;
	}
	/**
	 * 属性保险大类/保险大类的setter方法
	 */
	public void setRiskType(String riskType) {
		this.riskType = riskType;
	}
	/**
	 * 属性保险种类/保险种类的getter方法
	 */
	public String getRiskCode() {
		return riskCode;
	}
	/**
	 * 属性保险种类/保险种类的setter方法
	 */
	public void setRiskCode(String riskCode) {
		this.riskCode = riskCode;
	}
	/**
	 * 属性案件状态/案件状态 的getter方法
	 */
	public String getNodeStatus() {
		return nodeStatus;
	}
	/**
	 * 属性案件状态/案件状态 的setter方法
	 */
