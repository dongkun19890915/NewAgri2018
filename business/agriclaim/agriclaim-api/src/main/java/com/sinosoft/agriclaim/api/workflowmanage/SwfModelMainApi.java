 ...
 * @description 模板主表Api接口
 */
@FeignClient(name = AgriClaimConstant.AGRI_CLAIM_SERVICE_NAME, path = SwfModelMainApi.PATH)
public interface SwfModelMainApi {

    public static final String PATH = "swfModelMain";
