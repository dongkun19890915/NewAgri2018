 ...
 * 账户信息表Api操作对象
 */
public class PrpLsumpayDto extends BaseRequest implements Serializable{
	...
	/** 属性第三方机构ID/第三方机构ID */
	private java.lang.Integer taxdentifId ;		
	/** 属性卡/折类型/卡/折类型 */
	 ...
	 */
	public java.lang.Integer getTaxdentifId() {
		return taxdentifId;
	}
	/**
	 * 属性第三方机构ID/第三方机构ID的setter方法
	 */
	public void setTaxdentifId(java.lang.Integer taxdentifId) {
