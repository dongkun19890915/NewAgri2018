 ...
 */
@Entity
@Table(name = "PrpLClaimBillManager")
@IdClass(PrpLClaimBillManagerKey.class)
public class PrpLClaimBillManager extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性报案号/报案号 */
	@Id
	@Column(name = "registNo")
	private String registNo ;/** 属性理算书号/理算书号 */
	@Id
