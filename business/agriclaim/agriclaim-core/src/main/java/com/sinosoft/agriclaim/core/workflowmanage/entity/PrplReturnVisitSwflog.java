 ...
 */
@Entity
@Table(name = "PrplReturnVisitSwflog")
@IdClass(PrplReturnVisitSwflogKey.class)
public class PrplReturnVisitSwflog extends BaseEntityImpl{

	private static final long serialVersionUID = 1L;
	/** 属性业务号/业务号 */
	@Id
	@Column(name = "businessNo")
	private String businessNo ;/** 属性节点/节点 */
	@Id
	...
	/** 属性处理机构/处理机构 */
	@Column(name = "handlerComCode")
	private String handlerComCode ;
	/** 属性流入时间/流入时间 */
	@Column(name = "flowintoTime")
