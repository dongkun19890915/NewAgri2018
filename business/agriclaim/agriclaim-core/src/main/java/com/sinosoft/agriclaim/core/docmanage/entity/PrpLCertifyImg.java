...
@IdClass(PrpLCertifyImgKey.class)
public class PrpLCertifyImg extends BaseEntityImpl{
	...
	private java.lang.Double serialNo ;/** 属性标的代码/标的代码 */
	@Id
