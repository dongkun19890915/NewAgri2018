 ...
 * 危险单位标的表主键操作对象
 */
public class PrpLDangerItemKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpLDangerItemKey(){}
	public PrpLDangerItemKey(String certiNo,Integer dangerNo,Integer serialNo,Integer claimAddTimes){
