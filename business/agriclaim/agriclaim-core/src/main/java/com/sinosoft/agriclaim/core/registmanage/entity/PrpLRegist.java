...
@IdClass(PrpLRegistKey.class)
public class PrpLRegist extends BaseEntityImpl{
	...
	private java.lang.Double runDistance ;
	/** 属性车辆实际使用年限/车辆实际使用年限 */
	@Column(name = "useYears")
	private java.lang.Integer useYears ;
	/** 属性报案日期/报案日期 */
	...
	/** 属性现场标志/现场标志 */
	@Column(name = "siteFlag")
	private String siteFlag ;
	/** 属性伤害描述/伤害描述 */
	@Column(name = "damageDescribe")
	private String damageDescribe ;
	/** 属性范围描述/范围描述 */
	@Column(name = "woundDescribe")
	private String woundDescribe ;
	/** 属性损失类型/损失类型 */
	@Column(name = "lossType")
	private String lossType ;
	/** 属性损失等级/损失等级 */
	@Column(name = "lossLevel")
	private String lossLevel ;
	/** 属性确认手机号码/确认手机号码 */
	@Column(name = "insuredMobilePhone")
	...
	/** 属性确认标志/确认标志 */
	@Column(name = "isinsureFlag")
	private String isinsureFlag ;
	/** 属性驾驶员姓名/驾驶员姓名 */
	@Column(name = "driverName")
	private String driverName ;
	/** 属性驾驶类型/驾驶类型 */
	@Column(name = "driverFlag")
	private String driverFlag ;
	/** 属性注销类型/注销类型 */
	@Column(name = "logOutType")
	private String logOutType ;
	/** 属性注销标志/注销标志 */
	@Column(name = "logOutFlag")
	private String logOutFlag ;
	/** 属性注销申请人/注销申请人 */
	@Column(name = "logOutApplicant")
	private String logOutApplicant ;
	/** 属性注销申请时间/注销申请时间 */
	@Column(name = "logOutDateTime")
	private java.util.Date logOutDateTime ;
	/** 属性调查类型/调查类型 */
	@Column(name = "typeofinquiry")
	private String typeofinquiry ;
	/** 属性通融案件/通融案件 */
	@Column(name = "accommodationClaim")
	private String accommodationClaim ;
	/** 属性通融金额/通融金额 */
	@Column(name = "accommodationAmount")
	private java.lang.Double accommodationAmount ;
	/** 属性调查减损/调查减损 */
	@Column(name = "surveyDilute")
	private java.lang.Double surveyDilute ;
	/** 属性复堪减损/复堪减损 */
	@Column(name = "backcdilute")
	private java.lang.Double backcdilute ;
	/** 属性人伤减损/人伤减损 */
	@Column(name = "personDilute")
	private java.lang.Double personDilute ;
	/** 属性追偿案件/追偿案件 */
	@Column(name = "recoveryClaim")
	 ...
	 */
	public java.lang.Double getRunDistance() {
		return runDistance;
	}
	/**
	 * 属性车辆已行驶公里数/车辆已行驶公里数的setter方法
	 */
	public void setRunDistance(java.lang.Double runDistance) {
		this.runDistance = runDistance;
	} 	
	/**
	 * 属性车辆实际使用年限/车辆实际使用年限的getter方法
	 */
	public java.lang.Integer getUseYears() {
		return useYears;
	}
	/**
	 * 属性车辆实际使用年限/车辆实际使用年限的setter方法
	 */
	public void setUseYears(java.lang.Integer useYears) {
	 ...
	 */
	public java.lang.Double getAccommodationAmount() {
		return accommodationAmount;
	}
	/**
	 * 属性通融金额/通融金额的setter方法
	 */
	public void setAccommodationAmount(java.lang.Double accommodationAmount) {
		this.accommodationAmount = accommodationAmount;
	} 	
	/**
	 * 属性调查减损/调查减损的getter方法
	 */
	public java.lang.Double getSurveyDilute() {
		return surveyDilute;
	}
	/**
	 * 属性调查减损/调查减损的setter方法
	 */
	public void setSurveyDilute(java.lang.Double surveyDilute) {
		this.surveyDilute = surveyDilute;
	} 	
	/**
	 * 属性复堪减损/复堪减损的getter方法
	 */
	public java.lang.Double getBackcdilute() {
		return backcdilute;
	}
	/**
	 * 属性复堪减损/复堪减损的setter方法
	 */
	public void setBackcdilute(java.lang.Double backcdilute) {
		this.backcdilute = backcdilute;
	} 	
	/**
	 * 属性人伤减损/人伤减损的getter方法
	 */
	public java.lang.Double getPersonDilute() {
		return personDilute;
	}
	/**
	 * 属性人伤减损/人伤减损的setter方法
	 */
	public void setPersonDilute(java.lang.Double personDilute) {
