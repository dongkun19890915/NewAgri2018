 ...
 * 单证及影像表主键操作对象
 */
public class PrpLCertifyImgKey extends BasePKImpl{
	private static final long serialVersionUID = 1L;
	public PrpLCertifyImgKey(){}
	public PrpLCertifyImgKey(String businessNo,java.lang.Double serialNo,String lossItemCode){
