...
@IdClass(PrpLRegistRPolicyKey.class)
public class PrpLRegistRPolicy extends BaseEntityImpl{
	...
	/** 属性车牌号/车牌号 */
	@Column(name = "licensenNo")
	private String licensenNo ;
	/** 属性出险次数/出险次数 */
	@Column(name = "dangerTimes")
	...
	/** 属性录入人归属机构/录入人归属机构 */
	@Column(name = "registComCode")
	private String registComCode ;
	/** 属性注销日期/注销日期 */
	@Column(name = "cancelDate")
	private String cancelDate ;
	/** 属性注销操作人员代码/注销操作人员代码 */
	@Column(name = "cancelOperaterCode")
	private String cancelOperaterCode ;
	/** 属性注销机构代码/注销机构代码 */
	@Column(name = "cancelComCode")
